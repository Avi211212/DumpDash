...
public class AnimalElephantCharacterButton : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        ////////////////////////////////////////////////////////////////////
        if (GUI.Button(new Rect(720, 520, 120, 40), "Elephant_1"))
        {
            SceneManager.LoadScene("Elephant_01");
        }

        if (GUI.Button(new Rect(720, 560, 120, 40), "Elephant_2"))
        {
            SceneManager.LoadScene("Elephant_02");
        }

        if (GUI.Button(new Rect(720, 600, 120, 40), "Elephant_3"))
        {
            SceneManager.LoadScene("Elephant_03");
        }
    }
